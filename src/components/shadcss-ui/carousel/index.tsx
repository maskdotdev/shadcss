  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal" ? styles.carouselPreviousHorizontal : styles.carouselPreviousVertical,
        className
      )}
  ...
  return (
    <Button
      ...
      className={cn(
        styles.carouselButton,
        styles.carouselNext,
        orientation === "horizontal" ? styles.carouselNextHorizontal : styles.carouselNextVertical,
        className
      )}
